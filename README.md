...
`Meting-Agent` 是基于 **[metowolf/Meting](https://github.com/metowolf/Meting)** 构建的多平台音乐能力封装，目前提供两类交付物：
...
- 贡献流程与同步机制说明见 [docs/CONTRIBUTING.md](./docs/CONTRIBUTING.md)
